...
class RolloutResult:
    ...
    def _split_single_result_by_group(
        ...
        recomputed_logprobs_split = None
        if rollout_result.recomputed_logprobs is not None:
            recomputed_logprobs_split = torch.chunk(
                rollout_result.recomputed_logprobs, num_groups, dim=0
            )
        ...
        for i in range(num_groups):
            split_result = RolloutResult(
                ...
                recomputed_logprobs=recomputed_logprobs_split[i]
                if recomputed_logprobs_split is not None
                else None,
    ...
    def split_results(
        ...
        for i in range(split_num):
            split_result = RolloutResult(
                ...
                recomputed_logprobs=fields_split["recomputed_logprobs"][i],
    ...
    def split_results(
        ...
        for split_size in num_sequence_per_group:
            ...
            split_result = DynamicRolloutResult(
                ...
                recomputed_logprobs=split_recomputed_logprobs,
